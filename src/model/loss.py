...
class FastSpeech2Loss(nn.Module):
    ...
    def __init__(self, cfg: DictConfig):
        ...
        self.pitch_feature_level = "phoneme_level" if cfg.pitch_phoneme_averaging else "frame_level"
        self.energy_feature_level = "phoneme_level" if cfg.energy_phoneme_averaging else "frame_level"
    ...
    def forward(self, inputs, predictions):
        ...
        pitch_targets = inputs['pitch_targets']
        energy_targets = inputs['energy_targets']
        duration_targets = inputs['duration_targets']

        # extract necessary predictions
        mel_predictions = predictions['mel_outputs']
        postnet_mel_predictions = predictions['mel_outputs_postnet']
